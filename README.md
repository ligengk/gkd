...
- **已适配的规则需要等待发布更新才能生效，在 `GKD订阅界面` 下拉就能检测是否有更新 -> [点击查看更新日志](https://github.com/ligengk/gkd/releases)**

- **请求适配或报告问题 -> [点击反馈](https://github.com/ligengk/gkd/issues/new/choose)**

- **交流讨论 -> [点击查看或开启讨论](https://github.com/ligengk/gkd/discussions)**
...
```txt
https://raw.githubusercontent.com/ligengk/gkd/main/dist/ligengk_gkd.json5
```

- 当前版本: v1

- 当前订阅文件已适配 5 个应用，共有 75 应用规则组，3 全局规则组
